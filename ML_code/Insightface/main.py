from decode import recognize_faces, calculate_recognition_accuracy1
import cv2
import os
import onnxruntime
...
def run_with_image(image_path):
    ...
    dataset_path = "/Users/sivakarthick/Downloads/ML2_miniprj/Dataset/original_dataset_cropped"
    encodings_path = "/Users/sivakarthick/Downloads/ML2_miniprj/ML_code/Insightface/model/2023_27_AIML1.pickle"
    calculate_recognition_accuracy1(dataset_path, encodings_path)
